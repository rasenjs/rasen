...
// DOM type definitions for Rasen
// Adapted from Preact's dom.d.ts
...
export interface ClassAttributes<T> {
	ref?: Ref<T | null> | ((instance: T | null) => void);
}

export interface PreactDOMAttributes {
	children?: PropValue<string> | Mountable<HTMLElement> | Array<PropValue<string> | Mountable<HTMLElement>>;
...
// 直接使用 PropValue 类型，支持：直接值、Ref、或 getter 函数
...
// ============================================================================
// HTML Tag to Attributes Mapping for Rasen
// ============================================================================

/**
 * Maps HTML tag names to their corresponding attribute interfaces.
 * This enables type-safe element creation with autocomplete support.
 */
export interface HTMLElementAttributes {
	...
	q: BlockquoteHTMLAttributes<HTMLQuoteElement>;
 ...
 */
export type HTMLTagName = keyof HTMLElementAttributes;

/**
 * Get attributes type for a specific HTML tag
 */
export type HTMLTagAttributes<T extends HTMLTagName> = HTMLElementAttributes[T];
