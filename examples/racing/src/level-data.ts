...
export interface LevelPiece {
  ...
  y: number
  z: number
  /** Rasen rotationY (radians). */
  rotY: number
  scale: number
}

export const trackPieces: LevelPiece[] = [
  {
...
export const aiTrucks: LevelPiece[] = [
  {
    "name": "vehicle-truck-green",
    "x": -3.51261,
    "y": -0.00957274,
    "z": 12.7003,
    "rotY": -1.7112,
...
/** Ordered track centerline (world coords) — the driving loop, used for lap
 * counting and off-track detection. Derived from the decoded GridMap cells. */
export const trackCenterline: Array<{ x: number; z: number }> = [
  {
    "x": 3.7462,
    "z": 3.7462
  },
