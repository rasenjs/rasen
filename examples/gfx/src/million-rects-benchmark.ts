...
const pageHeader = div({
  ...
  children: [
    ...
    p({
      children: [
        'Performance test with 1,000,000 interactive rectangles using @rasenjs/gfx rect() components'
      ]
    })
  ]
})
...
const legend = div({
  ...
  children: [
    ...
    p({
      children: [
        '🎯 Each rectangle is created with @rasenjs/gfx rect() component'
      ]
    }),
    p({
