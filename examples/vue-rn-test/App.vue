...
<template>
  <View class="flex-1" :style="{ backgroundColor: '#0f0f1a', paddingTop: 60, paddingHorizontal: 16 }">
    <Text class="text-3xl font-bold" :style="{ color: '#e0e0ee', marginBottom: 20, textAlign: 'center' }">Vue RN Todos</Text>
