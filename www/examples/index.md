      ...
      view({
        ...
        children: [
          touchableOpacity({
            ...
            children: text({ style: { color: 'white', fontSize: 24 }, children: '-' })
          }),
          touchableOpacity({
            onPress: () => count.value++,
    ...
    div({
      ...
      children: [
        input({
          ...
          on: {
            input: (e) => newTodo.value = (e.target as HTMLInputElement).value,
    ...
    children: [
      ...
      ...Array.from({ length: 10 }, (_, i) => {
        ...
        return circle({
          ...
          radius: () => 5 + (10 - i),
          fill: () => `hsla(${(hue.value - i * 10) % 360}, 70%, 60%, ${0.1 + (10 - i) * 0.05})`
        })
      }),
