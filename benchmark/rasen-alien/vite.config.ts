...
// Isolated benchmark preview for Rasen backed by alien-signals (render-function,
// built dist packages). Mirrors benchmark/rasen except the reactive runtime.
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      '@rasenjs/reactive-alien-signals': resolve(
        __dirname,
        '../../packages/reactive-alien-signals/dist'
      )
    }
  }
})
